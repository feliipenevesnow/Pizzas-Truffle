...
import br.ifsp.edu.pep.view.jdialog.CrudPizza;
...
public class Pizzas extends javax.swing.JPanel {

    private Color cleanTextColor = new Color(153, 153, 153);
    private PizzaDAO control = new PizzaDAO();
    ...
    private void updateTable() {
        list = control.findAll(Pizza.class);
        insertTable();
    }
    ...
    private void insertTable() {
        ...
        for (Pizza obj : list) {
            Object objTable[] = {obj.getNome(), obj.getTamanho(), "R$" + obj.getPreco()};
    ...
    private void initTable() {
        ...
        table.addRow(new Object[]{"Mike Bhand", "mikebhand@gmail.com", "Admin"});
    }
    ...
    private void initComponents() {
        ...
        search.setText("Pesquise pizza por nome ...");
    ...
    private void searchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchFocusGained
        if (search.getText().equals("Pesquise pizza por nome ...")) {
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        CrudPizza view = new CrudPizza(null, true);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        if (table.getSelectedRow() != -1) {
            CrudPizza view = new CrudPizza(null, true);
            view.setPizza(list.get(table.getSelectedRow()));
            view.setUpdate(true);
            view.setVisible(true);
            updateTable();
        } else {
