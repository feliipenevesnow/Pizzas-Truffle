...
import br.ifsp.edu.pep.view.jdialog.CrudDrink;
...
public class Drink extends javax.swing.JPanel {
    ...
    private BebidaDAO control = new BebidaDAO();
    ...
    public void updateTable() {
        list = control.findAll(Bebida.class);
        insertTable();
    }
    ...
    private void insertTable() {
        ...
        for (Bebida obj : list) {
            Object objTable[] = {obj.getNome(), "R$ " + obj.getPreco(), obj.getQuantidade() + " Uni."};
    ...
    private void initComponents() {
        ...
        search.setText("Pesquise bebida por nome ...");
        ...
        panelBorder2Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder2Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(spTable, javax.swing.GroupLayout.DEFAULT_SIZE, 714, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void searchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchFocusGained
        if (search.getText().equals("Pesquise bebida por nome ...")) {
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        CrudDrink view = new CrudDrink(null, true);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        if (table.getSelectedRow() != -1) {
            CrudDrink view = new CrudDrink(null, true);
            view.setDrink(list.get(table.getSelectedRow()));
            view.setUpdate(true);
            view.setVisible(true);
            updateTable();
        } else {
            Notification notification = new Notification(null, true, "Selecione uma bebida", "Você deve selecionar uma bebida para concluir a ação.", false);
