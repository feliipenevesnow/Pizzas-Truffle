...
import br.ifsp.edu.pep.view.jdialog.CrudClient;
...
public class Client extends javax.swing.JPanel {
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        CrudClient view = new CrudClient(null, true);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        if (table.getSelectedRow() == -1) {
            Notification notification = new Notification(null, true, "Selecione um cliente", "Você deve selecionar um cliente para concluir a ação.", false);
