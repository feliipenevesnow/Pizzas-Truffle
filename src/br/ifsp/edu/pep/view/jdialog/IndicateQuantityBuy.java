...
public class IndicateQuantityBuy extends javax.swing.JDialog {
    ...
    private boolean precoVisivel = false;

    private ArrayList<IngredienteCompra> ingredientes = new ArrayList<>();
    private IngredienteCompra ingrediente = new IngredienteCompra();
    private ArrayList<BebidaCompra> bebidas = new ArrayList<>();
    private BebidaCompra bebeida = new BebidaCompra();
    ...
    public void verificarBebidas() {
        if (bebidas.contains(bebeida)) {
            preco.enable(false);
            precoVisivel = true;
        }
    }
    ...
    public void setIngrediente(IngredienteCompra ingrediente) {
    ...
    public void setBebeida(BebidaCompra bebeida) {
