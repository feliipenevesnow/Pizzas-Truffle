...
public class SelectUser extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        confirmarValor.setText("Fornecedor");
        ...
        jLabel4.setText("Usuário Selecionado");
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        if (table.getSelectedRow() == -1) {
            Notification notification = new Notification(null, true, "Selecione um ou mais usuários", "Você deve selecionar um ou mais usuários para concluir a ação.", false);
            notification.setVisible(true);
        } else {
            user = list.get(table.getSelectedRow());
            dispose();
        }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        Usuario user = list.get(table.getSelectedRow());
        confirmarValor.setText(user.getNome());
