...
public class SelectIngredient extends javax.swing.JDialog {

    private Point point = new Point();
    private IngredienteDAO control = new IngredienteDAO();
    ...
    public SelectIngredient(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        updateTable();
    ...
    private void updateTable() {
        list = control.findAll(Ingrediente.class);
        insertTable();
    }
    ...
    private void initComponents() {
        ...
        panelBorder7Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder7Layout.createSequentialGroup()
                .addGap(2, 2, 2)
                .addComponent(spIngredients, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
                .addContainerGap())
        );
        panelBorder7Layout.setVerticalGroup(
            ...
            .addGroup(panelBorder7Layout.createSequentialGroup()
                .addGap(2, 2, 2)
                .addComponent(spIngredients, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2))
        );
        ...
        panelBorder1Layout.setVerticalGroup(
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(confirm, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(confirm1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(panelBorder5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(15, 15, 15))
        );
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        if (table.getSelectedRow() == -1) {
            Notification notification = new Notification(null, true, "Selecione um ou mais ingredientes", "Você deve selecionar um ou mais ingredientes para concluir a ação.", false);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        Ingrediente ingredient = list.get(table.getSelectedRow());
        if (!selectedList.contains(ingredient)) {
            selectedList.add(ingredient);

            DefaultListModel model = new DefaultListModel();

            for (Ingrediente i : selectedList) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectIngredient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectIngredient dialog = new SelectIngredient(new javax.swing.JFrame(), true);
