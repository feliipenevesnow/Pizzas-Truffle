...
public class SelectSupplier extends javax.swing.JDialog {
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        if (table.getSelectedRow() == -1) {
            Notification notification = new Notification(null, true, "Selecione um ou mais fornecedors", "Você deve selecionar um ou mais fornecedors para concluir a ação.", false);
            notification.setVisible(true);
        } else {
            supplier = list.get(table.getSelectedRow());
            dispose();
        }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        Fornecedor supplier = list.get(table.getSelectedRow());
        confirmarValor.setText(supplier.getNome());
