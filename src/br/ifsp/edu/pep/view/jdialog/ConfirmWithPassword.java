...
public class ConfirmWithPassword extends javax.swing.JDialog {

    private Point point = new Point();
    private boolean confirm = false;

    public ConfirmWithPassword(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        if (email.getText().equals("") || String.valueOf(senha.getPassword()).equals("")) {
            ...
            if (email.getText().indexOf('@') != -1 && email.getText().indexOf('.') != -1) {
                if (UsuarioDAO.user.getSenha().equals(String.valueOf(senha.getPassword()))) {
                    ...
                    Notification notification = new Notification(null, true, "Atenção", "Ação negada.", false);
                    notification.setVisible(true);
                    dispose();
                }
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmWithPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmWithPassword dialog = new ConfirmWithPassword(new javax.swing.JFrame(), true);
