...
public class CrudIngredient extends javax.swing.JDialog {

    private Point point = new Point();

    public CrudIngredient(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jLabel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MouseClicked
        if (nome.getText().equals("")) {
            ...
            try {
                ...
                Logger.getLogger(CrudIngredient.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrudIngredient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrudIngredient dialog = new CrudIngredient(new javax.swing.JFrame(), true);
