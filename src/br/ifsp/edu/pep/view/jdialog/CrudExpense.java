...
public class CrudExpense extends javax.swing.JDialog {

    private Point point = new Point();
    private Despesa expense;
    private boolean update = false;

    public CrudExpense(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setExpense(Despesa expense) {
    ...
    private void setFields() {
        nome.setText(expense.getNome());
        preco.setValue(expense.getValor());
        vencimento.setDate(expense.getDataVencimento());
        descricao.setText(expense.getDescricao());
    }
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelBorder1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(vencimento, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            if (vencimento.getDate() != null) {
                if (confirmPrice.getText().equals("Valor confirmado R$ " + ((Number) preco.getValue()).doubleValue())) {
                    if (nome.getText().equals("") || ((Number) preco.getValue()).doubleValue() <= 0) {
                        ...
                        expense.setNome(nome.getText());
                        expense.setValor(((Number) preco.getValue()).doubleValue());
                        expense.setDescricao(descricao.getText());
                        expense.setDataVencimento(vencimento.getDate());
                        expense.setStatus("Aberta");

                        DespesaDAO control = new DespesaDAO();

                        if (!update) {
                            control.insert(expense);
                ...
                Notification notification = new Notification(null, true, "Atenção", "Data inválida.", false);
                notification.setVisible(true);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrudExpense.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrudExpense dialog = new CrudExpense(new javax.swing.JFrame(), true);
