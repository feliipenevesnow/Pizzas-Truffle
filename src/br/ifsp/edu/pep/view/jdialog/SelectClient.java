...
public class SelectClient extends javax.swing.JDialog {
    ...
    private void updateTable() {
        list = control.findAll(Cliente.class);
        insertTable();
    }
    ...
    private void initComponents() {
        ...
        search.setText("Pesquise cliente por nome ...");
        ...
        confirmarValor.setText("Cliente");
        ...
        panelBorder6Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(confirmarValor, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void searchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchFocusGained
        if (search.getText().equals("Pesquise cliente por nome ...")) {
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        if (table.getSelectedRow() == -1) {
            Notification notification = new Notification(null, true, "Selecione um ou mais clientes", "Você deve selecionar um ou mais clientes para concluir a ação.", false);
            notification.setVisible(true);
        } else {
            client = list.get(table.getSelectedRow());
            dispose();
        }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        Cliente client = list.get(table.getSelectedRow());
        confirmarValor.setText(client.getNome());
